 ...
 * @method \think\Collection jsonSearch(int $current, int $pageSize, ?bool $json = false, ?array $jsonField = null, ?array $map = null, ?array $jsonMap = null, ?array $order = ['id' => 'desc']) 搜索Json数据
